  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] gap-[50px]">
        ...
        <div
          ref={statsRef}
          className="border border-[#171717] bg-deep p-[40px] relative flex flex-col justify-center"
        >
          ...
          <div className="grid grid-cols-2 gap-[30px] text-center">
            {stats.map((stat, idx) => (
              <div key={idx}>
                <div
                  className="text-[50px] text-white leading-none mb-[5px] font-road-rage"
                  style={{
                    textShadow: "0 0 20px rgba(139,0,0,0.8)",
                    WebkitTextStroke: "1px var(--color-blood)",
                  }}
                >
                  {stat.val}
                </div>
                <div className="text-dim text-[12px] font-mono tracking-widest uppercase">
                  {stat.lbl}
                </div>
              </div>
            ))}
