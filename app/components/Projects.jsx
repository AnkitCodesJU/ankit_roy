...
const projects = [
  ...
  {
    id: "03",
    tag: "FULL-STACK · GEN-AI",
    title: "CVMorph",
    desc: "An AI-powered mock interview platform featuring automated technical interviews, secure JWT authentication, and detailed performance reporting.",
    chips: [
      "React",
      "Vite",
      "Express.js",
    ...
    website: "https://cv-morph-nine.vercel.app/",
    image: "/assets/cvmorph.png",
    longDesc: [
      "**AI-Powered Interviews**: Integrated a dedicated Gen-AI service to conduct automated mock interviews, process dynamic responses, and generate comprehensive evaluation reports.",
      "**Full-Stack Architecture**: Built using the MERN stack (**MongoDB, Express.js, React, and Node.js**) featuring **secure JWT-based authentication** and custom user token blacklisting.",
      "**Robust Backend Logic**: Designed modular controllers and routes to handle seamless user authentication, interview lifecycle management, and secure data storage.",
      "**Modern Frontend**: Powered by **Vite** and **Tailwind CSS** for a highly responsive, optimized UI, complete with dedicated loading states, protected routing, and context-driven state management.",
    ],
    techIcons: [
      { name: "React", slug: "react" },
      { name: "Vite", slug: "vite" },
